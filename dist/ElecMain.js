    ...
    (function (elec) {
        var ElecMain = /** @class */ (function (_super) {
            ...
            function ElecMain(canvas) {
                ...
                _this.eqLayer = new elec.EqLayer(_this);
                app.stage.addChild(_this.eqLayer);
                var battery = new elec.Battery(_this);
                _this.eqLayer.addChild(battery);
                battery.x = 500;
                battery.y = 300;
                var resistance = new elec.Resistance(_this);
                _this.eqLayer.addChild(resistance);
                resistance.x = 200;
                resistance.y = 300;
                console.log(battery);
                // init ticker
            ...
            ElecMain.prototype.update = function (deltaTime) {
                var eq;
                for (var i = 0; i < this.eqLayer.children.length; i++) {
                    eq = this.eqLayer.children[i];
            ...
            function DragPlugin(main) {
                ...
                _this.mouseDownHandler = function (e) {
                    if (e.target instanceof elec.EqBase) {
                        ...
                        _this.map[e.data.identifier] = new DragItem(e.target, e.data.identifier, _this.main.eqLayer.toLocal(e.data.global));
                    }
                };
                _this.mouseMoveHandler = function (e) {
                    ...
                    if (dragItem) {
                        ...
                        var p = _this.main.eqLayer.toLocal(e.data.global);
                ...
                _this.main.eqLayer.addListener("pointerdown", _this.mouseDownHandler);
